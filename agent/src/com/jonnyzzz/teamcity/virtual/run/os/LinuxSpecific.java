...
public class LinuxSpecific implements OSSpecific {
  ...
  @NotNull
  @Override
  public String getMountWorkPath(@NotNull VMRunnerContext ctx, @NotNull String s) {
    return getMountBasePath(ctx) + "/" + s.replace('\\', '/');
  }

  @NotNull
  @Override
  public String runScript(@NotNull final String guestWorkDir, @NotNull final String scriptName) {
    return "/bin/bash -c 'cd " + guestWorkDir + " && . " + scriptName + "'";
  }
}
