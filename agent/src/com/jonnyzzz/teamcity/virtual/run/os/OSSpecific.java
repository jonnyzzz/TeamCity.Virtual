...
public interface OSSpecific {
  ...
  /**
   * returns base path for mapping of local folder
   * @param ctx runner context
   * @return base path with trailing slash
   */
  @NotNull
  String getMountBasePath(@NotNull final VMRunnerContext ctx);

  @NotNull
  String getMountWorkPath(@NotNull final VMRunnerContext ctx,
                          @NotNull final String relativePath);

  @NotNull
  String runScript(@NotNull final String guestWorkDir,
